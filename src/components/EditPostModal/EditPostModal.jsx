...
export default function Modal({ isOpen, setIsOpen, post }) {
    ...
    const saveUserPost = () => {
        editPostHandler(post?._id, editedPost);
        setIsOpen(false);
    };
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-neutral-800 p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-2">
                                        {/* <p > */}
                                        <textarea
                                            className="text-medium bg-transparent text-gray-200"
                                            cols={50}
                                            rows={8}
